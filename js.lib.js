...
let HelloLib=function(params) {
    this.params=params;
    console.log("Hello World From The AutoForm library!",this.params)
}
HelloLib.prototype.init=function () {
    Object.keys(this.params).map(function(inp){
        ...
        console.log(textarea(this.params[inp].placeholder,this.params[inp].class,this.params[inp].col,this.params[inp].row,this.params[inp].id));
...
function textarea(ph,clsName,col,row,id){
